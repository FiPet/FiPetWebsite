        ...
        <div className="hidden md:flex md:flex-row items-center gap-8">
          <div className="w-full md:w-1/2 space-y-6 text-start">
            ...
            <p className="text-gray-700 md:text-[13px] lg:text-lg ">
              Complete quests, upgrade your FiPet, battle<br/>against your friends and
              learn real finance skills <br/> all from your fingertips.
            </p>  
            <div  className=" sm:h-auto md:w-[300px] mt-10 px-8 py-3 flex items-center justify-center text-white rounded-full transition-opacity hover:opacity-90"
              style={{
