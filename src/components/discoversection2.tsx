            ...
            <div className="max-w-screen-xl mx-auto px-6 py-12 md:py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="text-white space-y-6 md:pr-12">
                        ...
                        <p className="text-lg sm:text-xl">
                            Designed to feel like a game, not a textbook— inspired by Duolingo,
                            Pokémon, and Gen Z media habits.
                        </p>
                    </div>
                ...
                <div className="mt-16">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex items-start space-x-4 ">
                            <Image alt="" src="/assets/discover/XP.png" width={40} height={40} className="w-12 h-12 rounded-full flex-shrink-0" />
                        ...
                        <div className="flex items-start space-x-4">
                            <Image alt="" src="/assets/discover/arrow.png" width={40} height={40} className="w-12 h-12 rounded-full flex-shrink-0" />
                        ...
                        <div className="flex items-start space-x-4">
                            <Image alt="" src="/assets/discover/dollar sign.png" width={40} height={40} className="w-12 h-12 rounded-full flex-shrink-0" />
                        ...
                        <div className="flex items-start space-x-4">
                            <Image alt="" src="/assets/discover/Group 92.png" width={40} height={40} className="w-12 h-12 rounded-full flex-shrink-0" />

                            <p className="text-gray-700 text-xl">
                                <strong>Designed to engage both beginners</strong> and financially
                                savvy teens
                            </p>
                        </div>
                    </div>
